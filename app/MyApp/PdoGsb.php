...
/* ===== EXO 1 RECUP LES FRAIS UNITAIRE DE CHAQUE FORFAIT ===== */

public function getLesPrixUnitaire()
{
    $req = "SELECT montant FROM fraisforfait;";
    $res = $this->monPdo->query($req);
    $LesPrixUnitaires = $res->fetchAll();
    return $LesPrixUnitaires;
}
...
{
$req = "SELECT SUM(fraisforfait.montant * lignefraisforfait.quantite) 
        From fraisforfait
